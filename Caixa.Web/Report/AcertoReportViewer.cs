...
namespace Caixa.Web.Report
{
    public class AcertoReportViewer : ReportViewer
    {
        ...
        public override void MontaCorpoDados()
        {
            ...
            table.AddCell(getNewCell("N° Acerto", titulo, Element.ALIGN_LEFT, 10, PdfPCell.BOTTOM_BORDER, preto, fundo));
            ...
            table.AddCell(getNewCell("Entrada", titulo, Element.ALIGN_LEFT, 10, PdfPCell.BOTTOM_BORDER, preto, fundo));
            #endregion
            ...
            {
                table.AddCell(getNewCell(d.Id.ToString(), font, Element.ALIGN_LEFT, 5, PdfPCell.BOTTOM_BORDER));
                ...
                var totalEntrada = db.Acerto.Where(a=>a.Estabelecimento.Id == d.IdEstabelecimento).Sum(x => x.Entrada);
                table.AddCell(getNewCell(string.Format("{0:0.00}", totalEntrada), font, Element.ALIGN_LEFT, 5, PdfPCell.BOTTOM_BORDER));
            }
